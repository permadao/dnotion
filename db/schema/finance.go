...
func (f *FinData) DeserializePropertys(nid string, props notion.DatabasePageProperties) {
	f.NID = nid
...
func (f *FinData) SerializePropertys() (nid string, nprops *notion.DatabasePageProperties) {
